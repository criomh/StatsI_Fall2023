...
getwd()
# Confirmed it is C:/Users/criom/Documents/GitHub/StatsI_Fall2023/tutorials/03

# Set working directory if needed
setwd("C:/Users/criom/Documents/GitHub/StatsI_Fall2023/tutorials/03")
getwd()
...
View(df_not_tidy)
# Note several variables use "Yes" and "No", which R only reads as character strings - these would work better with R if we changed them to boolean TRUE and FALSE.
# Note the values for the release dates for threatres and for DVDs are spread across separate Year, Month, and Day variables - we want these to be combined into a single variable for easier use in R.
...
# Contingency table - x is the categorical variable "genre", y is the frequency of categorical variable "rating" spread across the x variable
